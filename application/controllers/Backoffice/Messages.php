...
class Messages extends CI_Controller {
	...
	public function __Construct(){
		parent::__Construct();
		$this->app->auth();
		$this->app->setActive('backoffice/messages');
		$this->layout = 'backoffice/messages/';
	...
	public function index(){
		...
		$this->app->render('Messages',$this->layout.'index',array('status'=>$status));
	}

	public function add(){
		$status = $this->model->GetStatus();
		$this->app->render('Messages - Create',$this->layout.'add',array('status'=>$status));
	}

	public function detail($id){
		redirect('backoffice/messages/read/'.$id);
	}

	public function edit($id){
		$data = $this->model->Detail($id);
		$status = $this->model->GetStatus();
		$this->app->render('Messages - Edit',$this->layout.'edit',array('data'=>$data,'status'=>$status));
	}
	...
	public function read($id){
		...
		$data = $this->model->Detail($id);
		$status = $this->model->GetStatus();
		$this->app->render('Messages - Read',$this->layout.'read',array('data'=>$data,'status'=>$status));
	}
	...
	public function forward($id = null){
		if($_POST){
			...
			redirect('backoffice/messages/read/'.$this->input->post('id'));
		}
		$data = $this->model->Detail($id);
	...
	public function reply($id = null){
		...
		$data = $this->model->Detail($id);
		$this->app->render('Messages - Reply',$this->layout.'reply',array('data'=>$data));
	}

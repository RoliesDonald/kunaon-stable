<div class="box">
  <div class="box-header with-border">
    <h3 class="box-title">Edit Credit Card</h3>
  </div><!-- /.box-header -->
  <!-- form start -->
    ...
    <div class="box-body">
      <div class="form-group">
        ...
        <div class="col-sm-10">
          ...
          <input class="form-control input-sm" id="credit_name" name="credit_name" value="<?php echo $data->credit_name;?>"  type="text" required>
        </div>
      </div>
    </div><!-- /.box-body -->

                        ...
                        <form class="form-horizontal" id="FormSubmit"  method="POST" action="<?php echo base_url($this->layout . 'submit'); ?>">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <input class="form-control input-sm" id="menu_name" name="menu_name"   type="text" required>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control input-sm price" id="price" name="price"  type="text" required>
                                </div>
                            </div>
                            <div class="form-group">

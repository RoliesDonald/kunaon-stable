    ...
    <div class="col-md-9">
        <div class="box">
            <div class="box-header with-border">
                <div class="box-title">
            <a href="<?php echo base_url();?>backoffice/messages/add" class="btn btn-primary btn-sm" data-toggle="tooltip" 
        ...
        <div class="box-tools">
             <a href="<?php echo base_url();?>backoffice/messages" class="btn btn-warning btn-sm pull-right" data-toggle="tooltip" 
                data-placement="top" title="Refresh">
                <i class="fa fa-refresh"></i> Refresh
            </a>
           <form method="POST" id="FormDelete" action="<?php echo base_url();?>backoffice/messages/delete">
